...
const DivergenciasJornadaPage = lazy(() => import("@/pages/admin/divergencias-jornada"));
  ...
  return (
    <Suspense fallback={<LazyFallback />}>
      <Switch>
        ...
        <Route path="/admin/divergencias-jornada">{() => <ProtectedRoute component={DivergenciasJornadaPage} />}</Route>
